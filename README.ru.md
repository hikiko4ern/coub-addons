...
- скрытие заблокированных каналов их контента (коубов, историй и комментариев)
- скрытие коубов по названию и тегам, содержащим указанные фразы или соответствующим регулярным выражениям
- скрытие рекоубов и репостов коубов и историй
...
- предотвращение обработки плеером нажатий <kbd>W</kbd>/<kbd>S</kbd>/<kbd>R</kbd>/<kbd>P</kbd>, если при этом нажат один из модификаторов (<kbd>Ctrl</kbd>/<kbd>Alt</kbd>/<kbd>Shift</kbd>/<kbd>Meta</kbd>)
