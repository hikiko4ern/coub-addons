...
import { MissingShardsError, type MissingShardsKey, NoShardsError } from '@/storage/errors';
...
const assertNotEmpty = (arrays: RawBlockedChannelsArrays) => {
