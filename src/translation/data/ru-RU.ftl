...
prevent-player-built-in-hotkeys-if-mod-pressed = Предотвращать обработку <kbd>W</kbd>/<kbd>S</kbd>/<kbd>R</kbd>/<kbd>P</kbd> при нажатых модификаторах
prevent-player-built-in-hotkeys-if-mod-pressed-tooltip = Предотвращает обработку плеером нажатий <kbd>W</kbd>/<kbd>S</kbd>/<kbd>R</kbd>/<kbd>P</kbd>, если при этом нажат один из модификаторов (<kbd>Ctrl</kbd>/<kbd>Alt</kbd>/<kbd>Shift</kbd>/<kbd>Meta</kbd>)
